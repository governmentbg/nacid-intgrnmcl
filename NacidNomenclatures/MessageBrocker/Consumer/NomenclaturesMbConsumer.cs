...
{
    public class NomenclaturesMbConsumer
    {
        public readonly IConnection connection;

        public NomenclaturesMbConsumer()
        {
            ...
            connection = factory.CreateConnection(AppSettingsProvider.MessageBroker.NomenclaturesConsumer.Name);
        }
    }
}
